...
class EffectManager:
    ...
    def chain_explosion(self, x, y, radius):
        """Dramatic expanding ring burst used for chain-reaction kills."""
        for _ in range(40):
        ...
        self.shockwaves.append(Shockwave(x, y, C_ORANGE, max_r=int(radius)))
        self.shockwaves.append(Shockwave(x, y, C_YELLOW, max_r=int(radius * 0.6)))
        self.flashes.append([C_ORANGE, 90, 12])
